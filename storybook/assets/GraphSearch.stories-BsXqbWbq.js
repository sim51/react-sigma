import{j as o}from"./jsx-runtime-CLpGMVip.js";import{G as C,S as y,H as i,D as N,A as G}from"./style-CWrtVBmu.js";import{F as x,S as F}from"./FocusOnNode-C5KIvvG-.js";import{c as b}from"./react-sigma_layout-forceatlas2.esm.min-B42B0U0V.js";import{N as j}from"./sigma-node-image.esm-CMcYhJxg.js";import{r as t}from"./index-nBX9XC1j.js";import{j as v}from"./dataset-1qnfU1y1.js";import"./index-BH0m1Kqc.js";import"./index-BAf46qtL.js";import"./react-sigma_layout-core.esm.min-B8U1ie9s.js";const O={allowInvalidContainer:!0,nodeProgramClasses:{image:j},defaultNodeType:"image",defaultEdgeType:"arrow",labelDensity:.07,labelGridCellSize:60,labelRenderedSizeThreshold:15,labelFont:"Lato, sans-serif",zIndex:!0},d=({style:u})=>{const h=C.from(v),[r,a]=t.useState(null),[n,l]=t.useState(null),g=t.useCallback(e=>{console.log("onfocus",e),e===null?l(null):e.type==="nodes"&&l(e.id)},[]),S=t.useCallback(e=>{e===null?a(null):e.type==="nodes"&&a(e.id)},[]),f=t.useCallback(e=>e.length<=10?e:[...e.slice(0,10),{type:"message",message:o.jsxs("span",{className:"text-center text-muted",children:["And ",e.length-10," others"]})}],[]);return o.jsxs(y,{settings:O,style:u,graph:h,children:[o.jsx(x,{node:n??r,move:!n}),o.jsxs(i,{position:"bottom-right",children:[o.jsx(N,{}),o.jsx(G,{}),o.jsx(b,{})]}),o.jsx(i,{position:"top-right",children:o.jsx(F,{type:"nodes",value:r?{type:"nodes",id:r}:null,onFocus:g,onChange:S,postSearchResult:f})})]})};d.__docgenInfo={description:"",methods:[],displayName:"GraphSearchDemo",props:{style:{required:!1,tsType:{name:"CSSProperties"},description:""}}};const z=`import { ControlsContainer, FullScreenControl, SigmaContainer, ZoomControl } from '@react-sigma/core';
