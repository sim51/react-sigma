...
void main(void) {
  ...
  #else
  // Sizes:
`).concat(e.flatMap(function(i,o){var a=i.size;if("fill"in a)return[];a=a;var c="attribute"in a?"v_borderSize_".concat(o+1):w(a.value),l=(a.mode||_r)==="pixels"?"u_correctionRatio":"v_radius";return["  float borderSize_".concat(o+1," = ").concat(l," * ").concat(c,";")]}).join(`
`),`
