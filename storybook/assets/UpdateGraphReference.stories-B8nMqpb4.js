import{j as u,x as l}from"./react-sigma.min-BhnHEgVU.js";import{r}from"./index-Dl6G-zuu.js";import{u as f}from"./useRandom-BD5vX7bR.js";const o=({style:c})=>{const{randomGraph:t}=f(),[p,m]=r.useState(t()),i=r.useMemo(()=>({allowInvalidContainer:!0}),[]);return r.useEffect(()=>{const d=setInterval(()=>{m(t)},1e3);return()=>{clearInterval(d)}},[]),u.jsx(l,{style:c,graph:p,settings:i})};o.__docgenInfo={description:"",methods:[],displayName:"UpdatedGraphReference",props:{style:{required:!1,tsType:{name:"CSSProperties"},description:""}}};const g=`import { FC, useEffect, useMemo, useState, CSSProperties } from "react";
