import{j as l,k as f,_ as y,G as g}from"./react-sigma.min-Bv1msYwt.js";import{r as h}from"./index-Dl6G-zuu.js";import{a as C}from"./react-sigma_layout-circular.esm.min-CxXfIbzy.js";import{u as b}from"./useRandom-Bw2Vt9je.js";import"./react-sigma_layout-core.esm.min-DWwCZ2Eh.js";const G=()=>{const{faker:o,randomColor:i}=b(),{positions:u,assign:s}=C(),n=y();return h.useEffect(()=>{const a=new g;for(let r=0;r<100;r++)a.addNode(r,{label:o.person.fullName(),size:o.number.int({min:4,max:20}),color:i(),x:0,y:0});for(let r=0;r<100;r++)for(let e=r+1;e<100;e++)Math.random()<.1&&a.addDirectedEdge(r,e),Math.random()<.1&&a.addDirectedEdge(e,r);n(a),s(),console.log(u())},[s,n,o.datatype,o,i]),null},m=({style:o})=>l.jsx(f,{style:o,settings:{allowInvalidContainer:!0},children:l.jsx(G,{})});m.__docgenInfo={description:"",methods:[],displayName:"LayoutCircular",props:{style:{required:!0,tsType:{name:"CSSProperties"},description:""}}};const x=`import { FC, useEffect, CSSProperties } from "react";
