import{j as n,x as m}from"./react-sigma.min-Bupy2-id.js";import{r as l}from"./index-Dl6G-zuu.js";import{u}from"./react-sigma_layout-forceatlas2.esm.min-DzV-F8N6.js";import{S as c}from"./SampleGraph-alOUFh88.js";import"./react-sigma_layout-core.esm.min-DJiRb8MY.js";import"./react-sigma_layout-circular.esm.min-BhYom5y4.js";import"./useRandom-fRaoFeZj.js";const p=()=>{const{start:t,kill:e}=u({settings:{slowDown:10}});return l.useEffect(()=>(t(),()=>{e()}),[t,e]),null},g={allowInvalidContainer:!0},i=({style:t})=>n.jsxs(m,{style:t,settings:g,children:[n.jsx(c,{}),n.jsx(p,{})]});i.__docgenInfo={description:"",methods:[],displayName:"LayoutFA2",props:{style:{required:!0,tsType:{name:"CSSProperties"},description:""}}};const y=`import { FC, useEffect, CSSProperties } from "react";
