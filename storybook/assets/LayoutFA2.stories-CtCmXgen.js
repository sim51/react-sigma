import{j as e}from"./jsx-runtime-CLpGMVip.js";import{S as i}from"./style-BRRu8M1x.js";import{n as l}from"./react-sigma_layout-forceatlas2.esm.min-OZDjdQJf.js";import{r as u}from"./index-nBX9XC1j.js";import{S as p}from"./SampleGraph-DQJNK4dY.js";import"./react-sigma_layout-core.esm.min-BU3fcF5-.js";import"./react-sigma_layout-circular.esm.min-BJiOJd2N.js";import"./useRandom-GyQuEz43.js";const c=()=>{const{start:r,kill:n}=l({settings:{slowDown:10}});return u.useEffect(()=>(r(),()=>{n()}),[r,n]),null},m=({style:r})=>e.jsxs(i,{style:r,settings:{allowInvalidContainer:!0},children:[e.jsx(p,{}),e.jsx(c,{})]});m.__docgenInfo={description:"",methods:[],displayName:"LayoutFA2",props:{style:{required:!0,tsType:{name:"CSSProperties"},description:""}}};const y=`import { SigmaContainer } from '@react-sigma/core';
