...
export const tests: Tests = [
  { name: "complete", url: "http://localhost:8000/complete.html?seed=foo&faTime=-1", waitFor: 1000, failureThreshold: 0.001 },
  { name: "multiple", url: "http://localhost:8000/multiple.html?seed=foo&faTime=-1", waitFor: 1000, failureThreshold: 0.001 },
  { name: "custom-btn", url: "http://localhost:8000/custom-buttons.html?seed=foo&faTime=-1", waitFor: 1000, failureThreshold: 0.015 },
];
