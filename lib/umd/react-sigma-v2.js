...
})(this, function(__WEBPACK_EXTERNAL_MODULE__6__, __WEBPACK_EXTERNAL_MODULE__2__, __WEBPACK_EXTERNAL_MODULE__5__) {
...
const sigma_1 = __webpack_require__(5);
const graphology_1 = __importDefault(__webpack_require__(6));
const context_1 = __webpack_require__(3);
...
const SigmaContainer = ({ graphOptions, id, className, style, initialSettings, children, }) => {
    ...
    react_1.useEffect(() => {
        if (containerRef.current !== null) {
            const instance = new sigma_1.Sigma(new graphology_1.default(graph.current), containerRef.current, settings.current);
            setSigma(instance);
        }
        return () => {
            setSigma(instance => {
...
const react_1 = __importStar(__webpack_require__(2));
const worker_1 = __importDefault(__webpack_require__(10));
const lodash_1 = __webpack_require__(7);
 ...
 */
var workerFunction = __webpack_require__(11),
    isGraph = __webpack_require__(12),
    helpers = __webpack_require__(13);
...
const ControlsContainer_1 = __webpack_require__(8);
...
const ForceAtlasControl_1 = __webpack_require__(9);
...
const SearchControl_1 = __webpack_require__(17);
