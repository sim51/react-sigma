...
import LayoutCircular from "../../src/components/example/LayoutCircular";
import LayoutCircularSource from "!!raw-loader!../../src/components/example/LayoutCircular";
import LayoutFA2 from "../../src/components/example/LayoutFA2";
import LayoutFA2Source from "!!raw-loader!../../src/components/example/LayoutFA2";
import LayoutFA2Control from "../../src/components/example/LayoutFA2Control";
import LayoutFA2ControlSource from "!!raw-loader!../../src/components/example/LayoutFA2Control";
...
<CodePreview code={LayoutCircularSource} title="Apply a circular layout on the graph">
  <LayoutCircular />
</CodePreview>
...
<CodePreview code={LayoutFA2Source} title="FA2 layout on the graph">
  <LayoutFA2 />
</CodePreview>
...
<CodePreview code={LayoutFA2ControlSource} title="Click on the FA2 controller">
  <LayoutFA2Control />
</CodePreview>
